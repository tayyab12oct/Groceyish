...
export const dailySells = [
    {
        ...
        products: [
            ...
            },
            {
                src: assets.products.img2,
                badge: "Best deal",
                badgeClass: "-mt-1.5 -ml-1.5 bg-primary-50 text-primary-100",
                imgMainClass: "w-full",
                title: "Potatos 1kg",
                category: "Vegetables",
                name: "Mr.food",
...
export const promotion = [
    {
        ...
        badge: "Free delivery",
        badgeClass: "bg-secondary-100",
        title: "Free delivery over $50 ",
        desc: "Shop $50 product and get free delivery anywhere.",
        btnValue: "Shop Now",
        src: assets.offer.offer1,
        imgClass: "2xl:w-46 lg:w-38 md:w-32 w-44 pr-1"
    },
    {
        mainClass: "bg-primary-200",
        badge: "60% off",
        badgeClass: "bg-primary-100",
        title: "Organic Food",
        desc: "Save up to 60% off on your first order",
        btnValue: "Order Now",
        src: assets.offer.offer2,
        imgClass: "2xl:w-72 md:w-56 w-40"
    },
]
