    ...
    return (
        <div className="relative w-68">
            ...
            <div className={twMerge(`relative bg-secondary-200 py-7 px-3 h-full`)}>
                <h1 className={twMerge(`2xl:text-3xl lg:text-2.5xl text-lg whitespace-nowrap text-black-200 font-bold text-center`)}>10% OFF</h1>
                <p className={twMerge(`text-black-200 2xl:text-lg lg:text-sm text-xs pt-3 2xl:leading-6 leading-5 2xl:pb-10 pb-6 text-center`)}>For new member sign up at the first time</p>
                <div className="py-1">
                    ...
                    <div className="flex items-center bg-white pl-3.5 space-x-3 max-w-xs w-full">
                        <img src={assets.icon.mail} className="w-4" alt="" />
                ...
                <div className="py-1">
                    ...
                    <div className="flex items-center bg-white pl-3.5 space-x-3 max-w-xs w-full">
                        <img src={assets.icon.mail} className="w-4" alt="" />
                        <Input id="password" type="password" placeholder="Maximum 8 characters" mainClass="w-full" inputClass="2xl:text-sm xl:text-xs text-sm py-3.5 pl-0 text-gray-100 placeholder-gray-100 bg-transparent" />
                    </div>
                </div>
                <Button
